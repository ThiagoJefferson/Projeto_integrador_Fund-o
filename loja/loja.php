...
<div class="login">
 ...
 <div class="dropdown show">
  <a1 class="btn btn-default dropdown-toggle" href="https://example.com" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <a style="font-size: 16px;" >Entrar</a>
  </a1>
<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="registro.php" style="font-size: 12px;">Login</a>
    <a class="dropdown-item" href="#" style="font-size: 12px;">Meus Pedidos</a>
     ...
     <div class="dropdown show">
  <a1 class="btn btn-default dropdown-toggle" href="https://example.com" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <a style="font-size: 12px;"> Olá, <?php echo $_SESSION["cliente"]; ?></a>
  </a1>
<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
  <a class="dropdown-item" href="#" style="font-size: 12px;">Minha conta</a>
    <a class="dropdown-item" href="#" style="font-size: 12px;">Meus Pedidos</a>
    <a class="dropdown-item" href="sair.php" style="font-size: 12px;">Sair</a>
  </div>
</div>
...
<div class="container">
        ...
        <?php
          ...
          $res = $MySQLiconn->query("SELECT * FROM produto");
