...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
  <a class="navbar-brand" style="font-size: 17px;" href="registro.php">Houle Store</a>
...
<a1>RG:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a1> <input type="text" name="rg" size="30">
<br><br>

<a1>CPF:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a1> <input type="text" name="cpf" size="30">
<br><br>

<a1>Senha:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a1> <input type="password" maxlength="11" border="" name="senha" size="30"> 
<br><br>

<a1>Endereço:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a1> <input type="text" name="endereco" size="30">
<br><br>

<a1>Conta Bancária:&nbsp;</a1> <input type="text" maxlength="8" name="conta_bancaria" size="30">
<br><br><br><br>
